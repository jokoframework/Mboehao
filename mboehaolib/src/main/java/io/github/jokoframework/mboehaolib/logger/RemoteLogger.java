...
import io.github.jokoframework.mboehaolib.pojo.RemoteLogPojo;

public class RemoteLogger {

        private static final int MAX_LOG_COUNT_TO_FLUSH = 3; // cantidad de logs que esperar para flush, antes era 20...
