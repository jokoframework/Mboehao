...
package io.github.jokoframework.otp.token;
...
import io.github.jokoframework.otp.token.Token.TokenUriInvalidException;
...
public class TokenPersistence {
    ...
    private static class SaveTokenTask extends AsyncTask<TaskParams, Void, ReturnParams> {
        ...
        protected void onPostExecute(ReturnParams returnParams) {
            ...
            returnParams.context.sendBroadcast(new Intent(OtpActivity.ACTION_IMAGE_SAVED));
        }
    }
}
