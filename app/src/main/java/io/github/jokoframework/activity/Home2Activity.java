...
public class Home2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String LOG_TAG = Home2Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.shareMain).setOnClickListener(v -> {
            Intent iShare = new Intent(Home2Activity.this, ShareActivity.class);
            startActivity(iShare);
            finish();
        });

        findViewById(R.id.optionsMain).setOnClickListener(v -> {
            Intent iPref = new Intent(Home2Activity.this, SettingsActivity.class);
            startActivity(iPref);
            finish();
        });
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder dialogBuilder = new MaterialAlertDialogBuilder(Home2Activity.this);

        dialogBuilder.setTitle("LOG OUT?").setMessage("You will return to Login Screen if you leave.")
        .setPositiveButton("YES", (dialog, which) -> {
            Intent leave = new Intent(Home2Activity.this, LogOutActivity.class);
            startActivity(leave);
            finish();
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            case R.id.lineChart:
                option = new Intent(Home2Activity.this, LineChartActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.barChart:
                option = new Intent(Home2Activity.this, BarChartActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.horiBarChart:
                option = new Intent(Home2Activity.this, HorizontalBarChartActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.multipleLineChart:
                option = new Intent(Home2Activity.this, MultipleLineChartActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.oneTimePass:
                option = new Intent(Home2Activity.this, OtpActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.roomPersistanceC:
                option = new Intent(Home2Activity.this, CountryActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.changePass:
                option = new Intent(Home2Activity.this, OptionsActivity.class);
                startActivity(option);
                finish();
                break;

            case R.id.about:
                option = new Intent(Home2Activity.this, AboutActivity.class);
                startActivity(option);
                finish();
                break;
